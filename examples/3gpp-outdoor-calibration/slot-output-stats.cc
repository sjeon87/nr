...
/**
 * @ingroup examples
 * @file slot-output-stats.cc
 *
 * @brief Implementation of SlotOutputStats, used by the cttc-nr-3gpp-calibration example to
 * record per-slot scheduling statistics of every gNB into the SQLite output database (table
