 ...
 *
 * @brief Declaration of SinrOutputStats, used by the lena-lte-comparison example to record the
 * SINR perceived by each UE into the SQLite output database (table "sinr"). Each row stores cell
 * ID, BWP ID, RNTI and the average SINR, keyed by RNG seed and run number; it is fed by the
