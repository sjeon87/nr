...
/**
 * @ingroup examples
 * @file rb-output-stats.h
 *
 * @brief Declaration of RbOutputStats, used by the lena-lte-comparison example to record the
 * per-symbol resource block occupancy of every gNB into the SQLite output database (table
