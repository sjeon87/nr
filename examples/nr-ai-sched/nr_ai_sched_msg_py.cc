...
PYBIND11_MODULE(ns3ai_nr_sched_py, m) {
  ...
  py::class_<ns3::NrSchedEnvMsg>(m, "NrSchedEnvMsg")
      ...
      .def(
          "get_obs",
          [](ns3::NrSchedEnvMsg &self,
             uint32_t idx) -> ns3::NrSchedObservation & {
  ...
  using MsgImpl =
      ns3::Ns3AiMsgInterfaceImpl<ns3::NrSchedEnvMsg, ns3::NrSchedActMsg>;
  py::class_<MsgImpl>(m, "Ns3AiMsgInterfaceImpl")
      .def(py::init<bool, bool, bool, uint32_t, const char *, const char *,
                    const char *, const char *>(),
           py::arg("is_memory_creator"), py::arg("use_vector"),
           py::arg("handle_finish"), py::arg("size"), py::arg("segment_name"),
           py::arg("cpp2py_msg_name"), py::arg("py2cpp_msg_name"),
           py::arg("lockable_name"))
      .def("PyRecvBegin", &MsgImpl::PyRecvBegin,
           "Block until C++ sends observations")
      .def("PyRecvEnd", &MsgImpl::PyRecvEnd,
           "Signal C++ that Python finished reading")
      .def("PySendBegin", &MsgImpl::PySendBegin,
           "Acquire lock to write actions")
      .def("PySendEnd", &MsgImpl::PySendEnd,
           "Signal C++ that actions are ready")
      .def("PyGetFinished", &MsgImpl::PyGetFinished,
           "Check if the simulation has ended")
      .def("GetCpp2PyStruct", &MsgImpl::GetCpp2PyStruct,
           py::return_value_policy::reference,
           "Get pointer to the observation envelope")
      .def("GetPy2CppStruct", &MsgImpl::GetPy2CppStruct,
           py::return_value_policy::reference,
