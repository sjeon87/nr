...
/**
 * @ingroup test
 * @file nr-test-rlc-um-transmitter.cc
 *
 * @brief Test suite `nr-rlc-um-transmitter`: transmitter-side behavior of NrRlcUm in isolation.
 * A test PDCP and a test MAC are wired to a real RLC UM entity through the RLC/MAC SAPs; the test
 ...
 * concatenation of several SDUs into one PDU, and the buffer status report primitive parameters.
 */
